...
echo -e "USE ${DATABASE};\n\nLOAD DATA INPATH '$HDFS_TEMP/fhv_tripdata_2023-01.parquet' INTO TABLE for_hire_vechicle;\nLOAD DATA INPATH '$HDFS_TEMP/fhvhv_tripdata_2023-01.parquet' INTO TABLE fhv_high_volume;\nLOAD DATA INPATH '$HDFS_TEMP/green_tripdata_2023-01.parquet' INTO TABLE green_tripdata;\nLOAD DATA INPATH '$HDFS_TEMP/yellow_tripdata_2023-01.parquet' INTO TABLE yellow_tripdata;" > $TEMP_LOCATION/load_data.hql
